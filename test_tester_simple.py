...
def test_tester_simple():
    """Test the LLM functionality without SSL certificate first"""
    
    # Test message
    test_message = "This is a simple test message."
    
    print("Testing LLM functionality without SSL certificate...")
    print(f"Test message: {test_message}")
    print("-" * 50)
    
    try:
        # Create LLM client WITHOUT SSL certificate first
        client = LLMGateway(
            ...
            # ssl_ca_cert=None,  # Try without SSL certificate
        ...
        system_prompt = "You are a helpful assistant. Please provide a brief response."
